...
> [!WARNING]  
> Version 27+ of Xperience by Kentico will be supported by early January 2024. You can use the prerelease version [![NuGet Package](https://img.shields.io/nuget/vpre/Kentico.Xperience.Lucene.svg)](https://www.nuget.org/packages/Kentico.Xperience.Lucene/3.0.0-v28preview) and learn more in the [feature_v28 branch](https://github.com/Kentico/xperience-by-kentico-lucene/tree/feature_v28).
...
1. Define a custom `LuceneSearchModel` implementation to represent the content you want index.
1. Define a custom `DefaultLuceneIndexingStrategy` implementation to customize how content/fields are processed for the index.
