...
Use `Kentico.Xperience.Lucene.Core` in your Xperience by Kentico Administration project for Lucene Search Administration UI managment.
For backwards compatibility `Kentico.Xperience.Lucene` is still supported. This is the project for the older version of Xperience by Kentico support for
