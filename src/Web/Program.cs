...
builder.Services.AddKentico(features =>
{
    ...
    features.UseWebPageRouting(new WebPageRoutingOptions { LanguageNameRouteValuesKey = DancingGoatConstants.LANGUAGE_KEY });
...
builder.Services.Configure<KenticoRequestLocalizationOptions>(options =>
{
    ...
    {
        RouteDataStringKey = DancingGoatConstants.LANGUAGE_KEY,
        UIRouteDataStringKey = DancingGoatConstants.LANGUAGE_KEY
    });
});
...
app.MapControllerRoute(
    ...
    pattern: $"{{{DancingGoatConstants.LANGUAGE_KEY}}}/{{controller}}/{{action}}",
    constraints: new
    {
