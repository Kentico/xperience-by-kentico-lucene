...
[assembly: RegisterWebPageRoute(ConfirmationPage.CONTENT_TYPE_NAME, typeof(DancingGoatConfirmationController), WebsiteChannelNames = new[] { WebsiteConstants.WEBSITE_CHANNEL_NAME })]
...
namespace DancingGoat.Controllers
{
    public class DancingGoatConfirmationController : Controller
    {
        ...
        public DancingGoatConfirmationController(ConfirmationPageRepository confirmationPageRepository, IWebPageDataContextRetriever webPageDataContextRetriever, ICurrentLanguageRetriever currentLanguageRetriever)
        {
