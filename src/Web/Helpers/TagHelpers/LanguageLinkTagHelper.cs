...
namespace DancingGoat.Helpers
{
    public class LanguageLinkTagHelper : TagHelper
    {
        ...
        public LanguageLinkTagHelper(
            ...
            ICurrentLanguageRetriever currentLanguageRetriever,
        ...
        private async Task<TagBuilder> GenerateActionLink(RouteValueDictionary routeValues)
        {
            ...
            {
                routeValues.Remove(DancingGoatConstants.LANGUAGE_KEY);
            ...
            routeValues[DancingGoatConstants.LANGUAGE_KEY] = LanguageName;
