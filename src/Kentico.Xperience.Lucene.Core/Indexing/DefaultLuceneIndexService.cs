...
public class DefaultLuceneIndexService : ILuceneIndexService
{
    ...
    {
        using LuceneDirectory indexDir = KenticoLuceneDirectory.Open(storage.Path);
        ...
        using LuceneDirectory taxonomyDir = KenticoLuceneDirectory.Open(storage.TaxonomyPath);
