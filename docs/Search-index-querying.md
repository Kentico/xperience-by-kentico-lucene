...
For the correct functioning of `UseSearcherWithFacets`, make sure to provide the configuration at search time using an override. If you don't want to use [facets](Custom-index-strategy.md#Add-facets), use `UseSearcher` instead.
